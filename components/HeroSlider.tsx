  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto px-2">
        ...
        {/* Logo Ufficiale Badge Maglietta (ad altissima definizione) */}
        <div className="mb-6 flex justify-center">
          <div className="relative w-36 h-36 sm:w-44 sm:h-44 md:w-48 md:h-48 transition-transform duration-500 hover:scale-105 filter drop-shadow-2xl">
            <img
              src="/images/tour-felici-badge-isolated.jpg"
